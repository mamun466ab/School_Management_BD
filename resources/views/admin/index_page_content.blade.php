                   ...
                   <div id="theme-change" class="hidden-phone">
                       <i class="icon-cogs"></i>
                        <span class="settings">
                            ...
                            <span class="colors">
                                <?php
                                    $themeTable = DB::table('theme')->get();
                                ?>
                                @foreach ($themeTable as $theme)                                    
                                    <span class="color-{{ $theme->color_class_name }}" data-style="{{ $theme->color_class_name }}"></span>
                                @endforeach
                            </span>
                        </span>
                   </div>
                         ...
                         <div class="widget-body">
                             <div class="timeline-messages">
                                 ...
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="#"><img alt="" src="{{ asset('img/avatar1.jpg') }}" class="avatar"></a>
                                 ...
                                 <!-- Comment -->
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="#"><img alt="" src="{{ asset('img/avatar2.jpg') }}" class="avatar"></a>
